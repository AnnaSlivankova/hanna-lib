...
export const Rating: FC<RatingProps> = ({
  ...
  emptySymbol = <StarBorder color={'var(--color-dark-100)'} height={24} />,
  fractions = 1,
  // fullSymbol = <Star color={'var(--color-danger-400)'} />,
  fullSymbol = <Star color={'var(--color-tertriary)'} height={24} />,
  id,
  onChange,
  onClick,
  onHover,
  ...
  placeholderSymbol = <Star color={'var(--color-tertriary)'} height={24} />,
  quiet = false,
  readonly = false,
  start = 0,
  step = 1,
